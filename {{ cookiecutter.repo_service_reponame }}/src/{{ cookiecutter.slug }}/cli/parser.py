...
from {{ cookiecutter.slug }}.cli           import util as _cli
from {{ cookiecutter.slug }}.cli.formatter import ArgumentParserFormatter
from {{ cookiecutter.slug }}.cli.util      import _CAN_ANSI_FORMAT
