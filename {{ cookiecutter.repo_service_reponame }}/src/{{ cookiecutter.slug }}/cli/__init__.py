...
from {{ cookiecutter.slug }}._compat import input

# imports - standard imports
import inspect

# imports - module imports
from {{ cookiecutter.slug }}.cli.parser import get_parsed_args
from {{ cookiecutter.slug }}.util.type  import merge_dict
