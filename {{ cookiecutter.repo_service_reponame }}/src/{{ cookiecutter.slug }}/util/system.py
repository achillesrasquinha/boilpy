...
from {{ cookiecutter.slug }}.util.string     import strip, safe_decode
from {{ cookiecutter.slug }}.util.environ    import SECRETS
from {{ cookiecutter.slug }}._compat         import iteritems, PY2
