...
from {{ cookiecutter.slug }}             import _compat
from {{ cookiecutter.slug }}._compat     import zip, _is_python_version
from {{ cookiecutter.slug }}.util._dict  import dict_from_list
