...
from {{ cookiecutter.slug }}.util._dict   import autodict
from {{ cookiecutter.slug }}._compat      import iteritems, configparser as cp
...
def environment():
    ...
    from {{ cookiecutter.slug }} import settings
